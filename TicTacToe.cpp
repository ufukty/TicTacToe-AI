		...
		while (board.is_game_ended() == false) {
			...
			if (board.next_token() == game.computer_token) { // Bilgisayarın sırası
				...
				if (response == SEAL_SUCCESS) {
					...
					display_message("Taken. Pick another one.");
				}
			}
